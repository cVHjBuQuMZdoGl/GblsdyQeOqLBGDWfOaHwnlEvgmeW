...
local LibraryInstance = Library:Window({
    Name = "$$$$",
})

local Page1 = LibraryInstance:Page({
    Name = "Page 1",
})
...
local Colorpicker1 = Section1:Colorpicker({
    Title = "Select Color",
...
local Multibox1 = Section1:Multibox({
...
local Page2 = LibraryInstance:Page({
    Name = "Page 2",
})

local Section2 = Page2:Section({
    Name = "Advanced Settings",
    LeftTitle = "Advanced Left",
    RightTitle = "Advanced Right",
})

local Toggle2 = Section2:Toggle({
    Name = "Enable Feature B",
    state = false,
    callback = function(value) end,
})

local Slider2 = Section2:Slider({
    Name = "Feature B Intensity",
    min = 0,
    max = 100,
    state = 75,
    callback = function(value) end,
...
local Colorpicker2 = Section2:Colorpicker({
    Title = "Select Color B",
    state = Color3.fromRGB(0, 255, 0),
    Alpha = 1,
    callback = function(color) end,
})

local Dropdown2 = Section2:List({
...
local Multibox2 = Section2:Multibox({
    Name = "Select Multiple Options B",
    Options = {"Option A", "Option B", "Option C"},
    Max = 2,
    callback = function(selected) end,
})

local Page3 = LibraryInstance:Page({
    Name = "Page 3",
})

local Section3 = Page3:Section({
    Name = "Miscellaneous",
    LeftTitle = "Misc Left",
    RightTitle = "Misc Right",
})

local Toggle3 = Section3:Toggle({
    Name = "Enable Feature C",
    state = false,
    callback = function(value) end,
})

local Slider3 = Section3:Slider({
    Name = "Feature C Speed",
    min = 1,
    max = 10,
    state = 5,
    callback = function(value) end,
...
local Colorpicker3 = Section3:Colorpicker({
    Title = "Select Color C",
    state = Color3.fromRGB(0, 0, 255),
    Alpha = 1,
    callback = function(color) end,
})

local Dropdown3 = Section3:List({
...
local Multibox3 = Section3:Multibox({
    Name = "Select Multiple Options C",
    Options = {"Option A", "Option B", "Option C"},
    Max = 2,
    callback = function(selected) end,
})

local Button1 = Section3:Button({
    Name = "Execute Action",
...
local function toggleMenu()
    LibraryInstance:SetOpen(not LibraryInstance.Open)
end
