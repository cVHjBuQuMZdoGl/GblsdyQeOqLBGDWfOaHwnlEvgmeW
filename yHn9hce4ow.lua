...
PriorityToggle.MouseButton1Click:Connect(function()
    ...
    if priorityDropdownOpen then
        ...
        for i, playerName in ipairs(pool) do
            -- Width indented slightly (-6) to accommodate space for the custom scrollbar track
        ...
        -- Cap height to show maximum of 5 items smoothly, scrollbar activates if capacity exceeds
