--[[
    ═══════════════════════════════════════════════════════════
                        ELEMENTS.WTF
                    Universal Purple Edition
                       Version 1.0 Optimized
    ═══════════════════════════════════════════════════════════
    
    💜 THEME: Purple (#8A2BE2)
    🔓 KEY SYSTEM: DISABLED (Free for all)
    
    ⚡ PERFORMANCE OPTIMIZATIONS:
    • FPS Counter: Heartbeat (2x per second instead of RenderStepped)
    • Status Bar: Updates every 2s instead of 1s
    • Reduced ping polling frequency
    • Optimized for low-end PCs
    
    🎮 SUPPORTED GAMES:
    • Da Hood (2788229376)
    • Da Hood VC (7213786345)
    • Da Hood Macro (16033173781)
    • Da Strike (110917236678062)
    • Da Uphill (100140099206873)
    • Da Downhill (130879446158509)
    • Hood Customs (9825515356)
    • OG Da Hood (17897702920)
    • And more...
    
    ✨ FEATURES:
    • Silent Aim with Prediction
    • Target Aim (Rage Mode)
    • Advanced ESP (Boxes, Names, Health, Armor)
    • Anti-Aim (Velocity Spoofer, C-Sync, Network Desync)
    • Movement (Speed, Jump, Fly)
    • 100+ Premium Features
    
    🔥 FULLY WORKING:
    ✅ Da Strike - Silent Aim + Target Aim
    ✅ Da Uphill - Silent Aim + Target Aim  
    ✅ Da Downhill - Silent Aim + Target Aim
    ✅ All Da Hood games
...
--[[
    Elements.wtf - Key System DISABLED
]]
...
do
    ...
    local OWNER_KEY = "ELEM-OWNER-X9K2-M7P4-MASTER"
    ...
    local VALID_KEYS = {
        ["ELEM-A1B2-C3D4-E5F6-TRIAL"]    = "TRIAL",
        ["ELEM-G7H8-I9J0-K1L2-TRIAL"]    = "TRIAL",
        ["ELEM-M3N4-O5P6-Q7R8-TRIAL"]    = "TRIAL",
        ["ELEM-S9T0-U1V2-W3X4-TRIAL"]    = "TRIAL",
        ["ELEM-Y5Z6-A7B8-C9D0-TRIAL"]    = "TRIAL",
        ["ELEM-E1F2-G3H4-I5J6-WEEKLY"]   = "WEEKLY",
        ["ELEM-K7L8-M9N0-O1P2-WEEKLY"]   = "WEEKLY",
        ["ELEM-Q3R4-S5T6-U7V8-WEEKLY"]   = "WEEKLY",
        ["ELEM-W9X0-Y1Z2-A3B4-WEEKLY"]   = "WEEKLY",
        ["ELEM-C5D6-E7F8-G9H0-WEEKLY"]   = "WEEKLY",
        ["ELEM-I1J2-K3L4-M5N6-MONTHLY"]  = "MONTHLY",
        ["ELEM-O7P8-Q9R0-S1T2-MONTHLY"]  = "MONTHLY",
        ["ELEM-U3V4-W5X6-Y7Z8-MONTHLY"]  = "MONTHLY",
        ["ELEM-A9B0-C1D2-E3F4-MONTHLY"]  = "MONTHLY",
        ["ELEM-G5H6-I7J8-K9L0-MONTHLY"]  = "MONTHLY",
        ["ELEM-M1N2-O3P4-Q5R6-LIFETIME"] = "LIFETIME",
        ["ELEM-S7T8-U9V0-W1X2-LIFETIME"] = "LIFETIME",
        ["ELEM-Y3Z4-A5B6-C7D8-LIFETIME"] = "LIFETIME",
        ["ELEM-E9F0-G1H2-I3J4-LIFETIME"] = "LIFETIME",
        ["ELEM-K5L6-M7N8-O9P0-LIFETIME"] = "LIFETIME",
    }
    ...
    screen.Name = "Elements_KeySystem"
    ...
    title_lbl.Text = '<font color="rgb(138,43,226)">Elements</font><font color="rgb(255,255,255)">.wtf</font>'
    ...
    input.PlaceholderText = "ELEM-XXXX-XXXX-XXXX-PLAN"
    ...
    plan_badge.Text = ""
    plan_badge.TextColor3 = Color3.fromRGB(138, 43, 226)
    ...
    -- Discord link
    local discord_lbl = Instance.new("TextLabel")
    discord_lbl.Size = UDim2.new(1, 0, 0, 20)
    discord_lbl.Position = UDim2.new(0, 0, 0, 224)
    discord_lbl.BackgroundTransparency = 1
    discord_lbl.Text = "Join our Discord: discord.gg/fVwPFfQc"
    discord_lbl.TextColor3 = Color3.fromRGB(100, 150, 255)
    discord_lbl.Font = Enum.Font.GothamBold
    discord_lbl.TextSize = 12
    discord_lbl.Parent = box
    
    -- Make it clickable
    local discord_btn = Instance.new("TextButton")
    discord_btn.Size = UDim2.new(1, 0, 0, 20)
    discord_btn.Position = UDim2.new(0, 0, 0, 224)
    discord_btn.BackgroundTransparency = 1
    discord_btn.Text = ""
    discord_btn.Parent = box
    discord_btn.MouseButton1Click:Connect(function()
        setclipboard("https://discord.gg/fVwPFfQc")
        discord_lbl.Text = "✅ Discord link copied to clipboard!"
        discord_lbl.TextColor3 = Color3.fromRGB(100, 255, 100)
        task.wait(2)
        discord_lbl.Text = "Join our Discord: discord.gg/fVwPFfQc"
        discord_lbl.TextColor3 = Color3.fromRGB(100, 150, 255)
    end)
    ...
    discord_btn.MouseEnter:Connect(function()
        discord_lbl.TextColor3 = Color3.fromRGB(150, 200, 255)
    end)
    ...
    local function show_expired(plan)
        ...
        e3.TextColor3 = Color3.fromRGB(138, 43, 226)
    ...
    if not key_valid then
        local function try_key()
            ...
            plan_badge.Text = "✅ " .. plan .. " — " .. time_left
            status.TextColor3 = Color3.fromRGB(100, 255, 100)
            status.Text = "Key accepted! Loading Elements.wtf..."
            btn.Active = false
            _G.FUSI0N_PLAN = plan
...
print("╔════════════════════════════════════╗")
print("║      Elements.wtf v1.0            ║")
print("║   Universal Purple Edition        ║")
...
do
	...
	do
		...
		function Library:New(Properties)
			...
			Logo.Name = "Logo"
			Logo.Text = '<font color="rgb(138,43,226)">Elements.wtf</font><font color="rgb(90,90,100)">  v1.0</font>'
			...
			local planColors = {
				...
				["OWNER"]    = {bg = Color3.fromRGB(138, 43, 226),  text = Color3.fromRGB(0, 0, 0)},
			}
			local planLabels = {
				["TRIAL"]    = "TRIAL",
				["WEEKLY"]   = "WEEKLY",
			...
			for s = 1, 35 do
				...
				star.BackgroundColor3 = Color3.fromRGB(138, 43, 226)
				...
				sg.Color = Color3.fromRGB(138, 43, 226)
			...
			SBStroke.Color = Color3.fromRGB(138, 43, 226)
			...
			-- Update server info every 2 seconds (reduced from 1 for better performance)
			task.spawn(function()
				local Players = game:GetService("Players")
				...
				while ServerBar and ServerBar.Parent do
					...
					task.wait(2)  -- Changed from 1 to 2 seconds
				end
			end)
			--
		...
		function Library:Watermark(Properties)
			local Watermark = {
				Name = (Properties.Name or Properties.name or "Elements.wtf | placeholder");
				AnimateText = nil;
			}
			--
			local Outline = Instance.new("Frame")
			...
			task.spawn(function()
				while task.wait() do
					for i = 1, #"Elements.wtf" do
						Watermark.AnimateText = string.sub("Elements.wtf", 1, i) .. "";
						Title.Text = Watermark.AnimateText .. " " .. Watermark.Name;
						task.wait(0.4);
					end;

					for i = #"Elements.wtf.club" - 1, 1, -1 do
						Watermark.AnimateText = string.sub("Elements.wtf", 1, i) .. "";
						Title.Text = Watermark.AnimateText .. " " .. Watermark.Name;
						task.wait(0.4);
					end;
...
--// window locals
local default_color = Color3.fromRGB(138, 43, 226);
...
local dahood_ids = {2788229376, 16033173781, 7213786345, 110917236678062, 100140099206873, 130879446158509}
...
if (not (isfolder("Elements.wtf"))) then
	makefolder("Elements.wtf");
end;
...
screen_gui_2.Name = "Elements.wtf";
...
do
	...
	do
		...
		instances["local_text"] = utility.instance_new("TextLabel", { 
			Name = "Elements.wtf",
			Parent = screen_gui_2,
			Text = '<font color="rgb(207, 227, 0)">Elements.wtf</font><font color="rgb(255, 255, 255)">.club</font>',
			BackgroundTransparency = 1,
			BorderSizePixel = 0,
		...
		do
			...
			utility.new_connection(run_service.Heartbeat, function()
				...
				if (enabled) then
					...
					local text = custom_text_enabled and '<font color="' .. text_color .. '">' .. features.get_text(custom_text) .. '</font>' or '<font color="' .. text_color .. '">Elements.wtf</font><font color="rgb(255, 255, 255)">.club</font>';
	...
	if (hookmetamethod) then
		...
		local __index; __index = hookmetamethod(game, "__index", LPH_NO_VIRTUALIZE(function(self, property)
			if (not checkcaller() and ((((flags["anti_aim_c_sync_enabled"] or (flags["anti_aim_starhook_classics_enabled"] and (flags["anti_aim_starhook_classics"] == "Destroy Cheaters" or flags["anti_aim_starhook_classics"] == "supercoolboi34 Destroyer"))) and (flags["anti_aim_c_sync_keybind"] or flags["anti_aim_starhook_classics_keybind"]))) and property == "CFrame" and self == local_player.Character.HumanoidRootPart)) then
				return locals.original_position or CFrame.new(0, 0, 0);
			end;
...
do
	...
	local watermark = library:Watermark({Name = "Elements.wtf | Universal"});

	-- Game Detection Notification
	task.spawn(function()
		task.wait(2)
		local game_info = game_support[game.PlaceId]
		if game_info then
			library:Notification("🎮 " .. game_info.Name .. " detected!", 5)
		else
			library:Notification("⚠️ Game not officially supported - some features may not work", 5)
		end
	end)
	...
	local function notifyOwnerJoin(player)
		...
		pcall(function()
			StarterGui:SetCore("SendNotification", {
				Title = "👑 Elements.wtf",
				Text = "💜 Elements.wtf developer has joined the server!",
				Icon = headshot,
				Duration = 15
			})
		end)
		...
		astroke.Color = Color3.fromRGB(138, 43, 226)
		...
		atitle.Text = "Elements.wtf"
		atitle.TextColor3 = Color3.fromRGB(138, 43, 226)
		...
		amsg.Text = "💜 Elements.wtf developer has joined the server!"
	...
	local function alertMod(player)
		...
		-- Also show Elements notification
	...
	task.spawn(function()
		...
		local payload = {
			embeds = {
				{
					title = "⭐ Elements.wtf — Player Joined",
					...
					footer = {
						text = "Elements.wtf v1.0 • fusi0n.gg"
					},
	...
	task.spawn(function()
		...
		game:GetService("RunService").Heartbeat:Connect(function()
			frames = frames + 1
			if tick() - last >= 0.5 then  -- Update every 0.5s instead of 1s for smoother display
				local fps = math.floor(frames * 2)  -- Multiply by 2 since we're checking twice per second
				frames = 0
				last = tick()
	...
	do
		...
		do
			...
			do
				...
				smoothing_option_list:Slider({Name = "Smoothing Amount", Flag = "legit_assist_smoothing_amount", Default = 5, Minimum = 1, Maximum = 100, Decimals = 0.01, Ending = "%"});
			...
			do
				...
				legit_silent_aim:Toggle({Name = "Target Bots/NPCs", Flag = "target_bots_enabled"});
	...
	do
		...
		do
			...
			rage_main_target_aim:Keybind({Flag = "rage_target_aim_key", Default = Enum.KeyCode.E, Mode = "Toggle", Callback = function(key)
				...
				if new_target then
					if auto_switch then
						-- Auto switch: always target closest
						locals.target_aim.is_targetting = true;
						locals.target_aim.target = new_target;
					else
						-- Manual toggle: E key toggles on/off
						locals.target_aim.is_targetting = not locals.target_aim.is_targetting;
						if locals.target_aim.is_targetting then
							locals.target_aim.target = new_target;
						else
							locals.target_aim.target = nil;
						end;
					end;
				else
					-- No target found
					locals.target_aim.is_targetting = false;
					locals.target_aim.target = nil;
				end;
	...
	do
		...
		local starhook_classics = ui.tabs["anti_aim"]:Section({Name = "Elements.wtf Classics", Side = "Left", Size = 150});
	...
	do --// credits to finobe wtv im way too lazy
		...
		if not isfolder("Elements.wtf/configs") then 
		    makefolder("Elements.wtf/configs");
		end;

		local function update_config_list()
		    local list = {};
		
		    for idx, file in listfiles("Elements.wtf/configs") do
		        local file_name = file:gsub("Elements.wtf/configs\\", ""):gsub(".cfg", ""):gsub("Elements.wtf/configs/", "");
		...
		cfgs:Button({Name = "Create", Callback = function()
		    ...
		    if config_name == "" or isfile("Elements.wtf/configs/" .. config_name .. ".cfg") then
		        return;
		    end;
		    writefile("Elements.wtf/configs/" .. config_name .. ".cfg", Library:GetConfig());
		    update_config_list();
		end});
		...
		cfgs:Button({Name = "Save", Callback = function()
		    ...
		    if selected_config then
		        writefile("Elements.wtf/configs/" .. selected_config .. ".cfg", Library:GetConfig());
		    end;
		end});
		...
		cfgs:Button({Name = "Load", Callback = function()
		    local selected_config = flags.setting_configuration_list;
		    if selected_config then
		        Library:LoadConfig(readfile("Elements.wtf/configs/" .. selected_config .. ".cfg"));
		    end;
		end});
		...
		cfgs:Button({Name = "Delete", Callback = function()
		    local selected_config = flags.setting_configuration_list;
		    if selected_config then
		        delfile("Elements.wtf/configs/" .. selected_config .. ".cfg");
		    end;
		    update_config_list();
		end});
		...
		local fps_boost_toggle = window:Toggle({Name = "FPS Booster", Flag = "fps_booster", Callback = function(state)
			local Lighting = game:GetService("Lighting")
			local Terrain = workspace:FindFirstChildOfClass("Terrain")
			
			if state then
				-- Enable FPS boost
				Library:Notification("⚡ FPS Booster enabled!", 3)
				...
				-- Disable FPS boost (restore defaults)
				Library:Notification("FPS Booster disabled", 3)
		...
		local fps_boost_list = fps_boost_toggle:OptionList({});
		fps_boost_list:Toggle({Name = "Remove Textures", Flag = "fps_remove_textures", Default = true});
		fps_boost_list:Toggle({Name = "Remove Particles", Flag = "fps_remove_particles", Default = true});
		fps_boost_list:Toggle({Name = "Disable Shadows", Flag = "fps_disable_shadows", Default = true});
		...
		window:List({Name = "Color Theme", Flag = "ui_color_theme", Options = {"Elements Purple", "Ocean Blue", "Royal Purple", "Blood Red", "Emerald Green", "Snow White"}, Default = "Elements Purple", Callback = function(theme)
			local themes = {
				["Elements Purple"] = Color3.fromRGB(138, 43, 226),
