...
NotifyInstances.NotifyLabel.Name = "NotifyLabel";NotifyInstances.NotifyLabel.Size = UDim2.new(0.435253477, 0, 0.132743374, 0);NotifyInstances.NotifyLabel.BorderColor3 = Color3.fromRGB(0, 0, 0);NotifyInstances.NotifyLabel.BackgroundTransparency = 1;NotifyInstances.NotifyLabel.Position = UDim2.new(0.0823732466, 0, 0.86725682, 0);NotifyInstances.NotifyLabel.BorderSizePixel = 0;NotifyInstances.NotifyLabel.BackgroundColor3 = Color3.fromRGB(255, 255, 255);NotifyInstances.NotifyLabel.TextColor3 = Color3.fromRGB(255, 255, 255);NotifyInstances.NotifyLabel.Text = "Locked on: player";NotifyInstances.NotifyLabel.TextWrapped = true;NotifyInstances.NotifyLabel.TextSize = 24;NotifyInstances.NotifyLabel.FontFace = Font.new("rbxasset://fonts/families/RobotoMono.json", Enum.FontWeight.Regular, Enum.FontStyle.Normal);NotifyInstances.NotifyLabel.TextScaled = false;
		...
		if MiscConfiguration.TargetAim.LockedOn then
			...
			if OnScreen then
				...
				if TargetPlayer ~= nil then  
					...
					if Configuration.TargetAim.Main.Notify then
						CreateNotify(
							"Targetting: "..MiscConfiguration.TargetAim.TargetPlayer.Name,
							3,
							Color3.fromRGB(255,255,255)
						)
					end
...
TargetAimNC = hookmetamethod(game, "__namecall", newcclosure(function(...)
	local Arguments = {...}
	local MousePositions = {"UpdateMousePos"}
	local TargetPlayer = MiscConfiguration.TargetAim.TargetPlayer
...
local Window = Library:CreateWindow({
	Title = 'DREAMY.SLUT - A SPECIAL GUI WITH ONLY 5 USERS!',
	Center = true,
	AutoShow = true,
})
...
local Tabs = {
	...
	Misc = Window:AddTab('character');
	Settings = Window:AddTab('settings');
}

--// Target aim

local TargetAimGB = Tabs.Rage:AddLeftGroupbox('bullet redirection')
...
local ResolverBRO = Tabs.Rage:AddLeftGroupbox('anti-lock resolver')


ResolverBRO:AddToggle('TaResolver', {
	Text = 'resolver',
	Default = false,
...
ResolverBRO:AddDropdown('TaResolverMethod', {
	Values = {'MoveDirection', 'Recalculation'},
	Default = 1, 
	Multi = false, 
...
local TARGETOPTIONSWWHWWW = Tabs.Rage:AddLeftGroupbox('options')

TARGETOPTIONSWWHWWW:AddToggle('TaLookat', {
	Text = 'face target',
	Default = false,
...
TARGETOPTIONSWWHWWW:AddToggle('TaSpectate', {
	Text = 'spectate',
	Default = false,
...
TARGETOPTIONSWWHWWW:AddToggle('TaAimview', {
	Text = 'aimview target',
	Default = false,
...
TARGETOPTIONSWWHWWW:AddToggle('TaTargetGui', {
	Text = 'target stats',
	Default = false,
...
local visualsoptions = Tabs.Rage:AddLeftGroupbox('visual options')


visualsoptions:AddToggle('TaChams', {
...
visualsoptions:AddToggle('TaTracer', {
	Text = 'snapline',
	Default = false,
...
visualsoptions:AddToggle('TaHitbox', {
	Text = 'box',
	Default = false,
...
visualsoptions:AddSlider('TaTracerThickness', {
...
visualsoptions:AddSlider('TaHitboxSize', {
	Text = 'box size',
	Default = 6,
	Min = 1,
	Max = 20,
...
visualsoptions:AddDropdown('TaHitboxMat', {
...
local fieldofviewfieldofviewbro = Tabs.Rage:AddRightGroupbox('field of view')


fieldofviewfieldofviewbro:AddToggle('TaUseFov', {
	Text = 'enabled',
	Default = false,
...
fieldofviewfieldofviewbro:AddToggle('TaFovFilled', {
	Text = 'fov filled',
	Default = false,
...
fieldofviewfieldofviewbro:AddSlider('TaFovRadius', {
	Text = 'fov radius',
	Default = 50,
	Min = 5,
	Max = 1000,
...
fieldofviewfieldofviewbro:AddSlider('TaFovTransparency', {
...
local FLAGSSSSSS = Tabs.Rage:AddRightGroupbox('flags')


FLAGSSSSSS:AddToggle('TaKnockcheck', {
	Text = 'knocked check',
	Default = false,
...
FLAGSSSSSS:AddToggle('TaGrabcheck', {
	Text = 'grabbed check',
	Default = false,
...
FLAGSSSSSS:AddToggle('TaWallcheck', {
	Text = 'wall check',
	Default = false,
...
FLAGSSSSSS:AddToggle('TaForcefieldcheck', {
	Text = 'ff check',
	Default = false,
...
local targetstrafee = Tabs.Rage:AddRightGroupbox('target strafe')


targetstrafee:AddToggle('TsEnabled', {
	Text = 'enabled',
	Default = false,
	Callback = function(Value)
...
targetstrafee:AddToggle('TsTpstrafe', {
	Text = 'rage mode',
	Default = false,
...
targetstrafee:AddSlider('TsSpeed', {
	Text = 'speed',
	Default = 1,
	Min = 1,
	Max = 100,
...
targetstrafee:AddSlider('TsHeight', {
	Text = 'height',
	Default = 1,
	Min = 1,
	Max = 100,
...
targetstrafee:AddSlider('TsDistance', {
	Text = 'distance',
	Default = 1,
	Min = 1,
	Max = 100,
...
local sadasdsadasdsa = Tabs.Rage:AddRightGroupbox('weapon')

sadasdsadasdsa:AddToggle('aaaaaaa', {
	Text = 'full auto',
	Default = false,
...
sadasdsadasdsa:AddSlider('TsDistance', {
	Text = 'bullet spread',
	Suffix = "%",
	Default = 1,
	Min = 1,
...
local AntiAimGB = Tabs.Misc:AddRightGroupbox('anti aim')
