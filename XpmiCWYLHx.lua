...
local L_1_ = {}
L_1_["CoreGui"] = game:GetService("CoreGui")
L_1_["TweenService"] = game:GetService("TweenService")

-- Xóa UI cũ nếu tồn tại
if L_1_["CoreGui"]:FindFirstChild("Status_UI") then
    L_1_["CoreGui"]["Status_UI"]:Destroy()
end

-- Khởi tạo ScreenGui
L_1_["MainGui"] = Instance.new("ScreenGui")
L_1_["MainGui"].Name = "Status_UI"
L_1_["MainGui"].ResetOnSpawn = false
L_1_["MainGui"].Parent = L_1_["CoreGui"]

-- Frame thông tin góc màn hình
L_1_["StatusFrame"] = Instance.new("Frame")
L_1_["StatusFrame"].Size = UDim2.new(0, 150, 0, 50)
L_1_["StatusFrame"].Position = UDim2.new(1, -10, .5, 0)
L_1_["StatusFrame"].AnchorPoint = Vector2.new(1, .5)
L_1_["StatusFrame"].BackgroundColor3 = Color3.fromRGB(0, 0, 0)
L_1_["StatusFrame"].BackgroundTransparency = .25
L_1_["StatusFrame"].BorderSizePixel = 0
L_1_["StatusFrame"].Parent = L_1_["MainGui"]

-- Bo góc và Viền cho StatusFrame
Instance.new("UICorner", L_1_["StatusFrame"]).CornerRadius = UDim.new(0, 6)
L_1_["StatusStroke"] = Instance.new("UIStroke", L_1_["StatusFrame"])
L_1_["StatusStroke"].Thickness = 2
L_1_["StatusStroke"].Color = Color3.fromRGB(0, 0, 0)

-- Text tiêu đề nhỏ
L_1_["TitleSmall"] = Instance.new("TextLabel", L_1_["StatusFrame"])
L_1_["TitleSmall"].Size = UDim2.new(1, -10, .5, 0)
L_1_["TitleSmall"].Position = UDim2.new(.5, 0, 0, 2)
L_1_["TitleSmall"].AnchorPoint = Vector2.new(.5, 0)
L_1_["TitleSmall"].BackgroundTransparency = 1
L_1_["TitleSmall"].Text = "chuoiray Hub - Kaitun"
L_1_["TitleSmall"].TextColor3 = Color3.fromRGB(0, 0, 0)
L_1_["TitleSmall"].TextSize = 13
L_1_["TitleSmall"].Font = Enum.Font.GothamBold

-- Text trạng thái (Status)
L_1_["StatusText"] = Instance.new("TextLabel", L_1_["StatusFrame"])
L_1_["StatusText"].Size = UDim2.new(1, -10, .4, 0)
L_1_["StatusText"].Position = UDim2.new(.5, 0, .5, 0)
L_1_["StatusText"].AnchorPoint = Vector2.new(.5, 0)
L_1_["StatusText"].BackgroundTransparency = 1
L_1_["StatusText"].Text = "Status : N/A"
L_1_["StatusText"].TextColor3 = Color3.fromRGB(0, 0, 0)
L_1_["StatusText"].TextSize = 12
L_1_["StatusText"].Font = Enum.Font.Gotham

-- Frame thông báo chính (Ở giữa phía trên)
L_1_["MainFrame"] = Instance.new("Frame")
L_1_["MainFrame"].Size = UDim2.new(0, 250, 0, 60)
L_1_["MainFrame"].Position = UDim2.new(.5, 0, .13, 0)
L_1_["MainFrame"].AnchorPoint = Vector2.new(.5, .5)
L_1_["MainFrame"].BackgroundColor3 = Color3.fromRGB(0, 0, 0)
L_1_["MainFrame"].BackgroundTransparency = .25
L_1_["MainFrame"].Parent = L_1_["MainGui"]

Instance.new("UICorner", L_1_["MainFrame"]).CornerRadius = UDim.new(0, 6)
L_1_["MainStroke"] = Instance.new("UIStroke", L_1_["MainFrame"])
L_1_["MainStroke"].Thickness = 2
L_1_["MainStroke"].Color = Color3.fromRGB(0, 0, 0)

-- Text hiển thị Hub
L_1_["MainTitle"] = Instance.new("TextLabel", L_1_["MainFrame"])
L_1_["MainTitle"].Size = UDim2.new(1, 0, 1, 0)
L_1_["MainTitle"].BackgroundTransparency = 1
L_1_["MainTitle"].Text = "chuoiray Hub"
L_1_["MainTitle"].TextColor3 = Color3.fromRGB(0, 0, 0)
L_1_["MainTitle"].TextSize = 14
L_1_["MainTitle"].Font = Enum.Font.GothamBold
