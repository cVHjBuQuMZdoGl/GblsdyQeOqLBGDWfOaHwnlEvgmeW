...
local WatermarkConnection = game:GetService('RunService').RenderStepped:Connect(function()
    ...
    Library:SetWatermark(('Radiant.Tech🌟| %s fps | %s ms'):format(
        math.floor(FPS),
...
ThemeManager:SetFolder('RadiantOnTncTheme')
SaveManager:SetFolder('RadintTechCFG')
