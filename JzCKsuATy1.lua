-- Blazed - Ultimate Edition (Working Toggle)
...
-- MAKE A SIMPLE TOGGLE BUTTON ON SCREEN
...
ToggleButton.MouseButton1Click:Connect(function()
    ...
    Window.Gui.Visible = MenuVisible
    ToggleButton.Text = MenuVisible and "☰ BLAZED MENU" or "✖ MENU HIDDEN"
    ToggleButton.BackgroundColor3 = MenuVisible and Color3.fromRGB(0, 0, 0) or Color3.fromRGB(100, 0, 0)
end)
...
local function chatSpam()
    ...
    local args = { ChatSpamMessage, "All" }
    pcall(function()
...
print("📌 Click the BLACK BUTTON in the top-left corner to open/close the menu!")
print("📌 You can DRAG the button anywhere on screen!")