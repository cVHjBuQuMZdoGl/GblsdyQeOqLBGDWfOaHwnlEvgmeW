...
local function generatePredictionsFromPing(pingValue)
    ...
    for pingMin = basePing, basePing + 100, 10 do
        ...
        -- Separate multi-axis predictions generated for storage references
...
task.spawn(function()
    while true do
        ...
        -- Dynamically calculate separate coefficients for both axes
...
local function calculatePrediction(targetChar, isPlayer)
    ...
    -- [[ INDEPENDENT X AND Y DECOUPLING POOL ]]
    ...
    -- Split calculation vectors cleanly so horizontal tracking uses scaleX, and vertical utilizes scaleY
