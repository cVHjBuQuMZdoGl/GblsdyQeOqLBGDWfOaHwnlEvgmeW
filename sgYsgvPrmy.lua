...
local Obsidian = loadstring(game:HttpGet("https://raw.githubusercontent.com/batusz/Obsidian/main/ObsidianMain.lua"))()
...
local AimGroup = MainTab:CreateSection("Aimlock")
local SettingsGroup = MainTab:CreateSection("Aimlock Settings")
local CamlockGroup = MainTab:CreateSection("Camlock Settings")
local TriggerGroup = LegitTab:CreateSection("Triggerbot")
local HitboxGroup = LegitTab:CreateSection("Hitbox Expander")
local StrafeGroup = RageTab:CreateSection("Target Strafe")
local ReplicationGroup = RageTab:CreateSection("Replication Freeze")
...
CamlockGroup:AddInput('HorizontalPrediction', {
...
CamlockGroup:AddInput('VerticalPrediction', {
...
CamlockGroup:AddInput('HorizontalStrength', {
...
CamlockGroup:AddInput('VerticalStrength', {
...
CamlockGroup:AddInput('CameraSmoothness', {
...
CamlockGroup:AddInput('CameraShake', {
    Text = 'Camera Shake',
...
CamlockGroup:AddInput('JumpOffset', {
    Text = 'Jump Offset',
...
do
    ...
    InfRangeGroup:AddInput('InfRange_MaxRange', {
        Text = 'Max Range',
...
do
    ...
    AntiVoidGroup:AddInput('AntiVoid_HeightLimit', {
        Text = 'Height Limit',
    ...
    AntiVoidGroup:AddInput('AntiVoid_RegenY', {
        Text = 'Regen Height (Y)',
...
do
    ...
    StompGroup:AddInput('Stomp_Range', {
        Text = 'Stomp Range',
