...
RightGroupBox:AddDropdown('AutoPredMode', {
    ...
    Default = getgenv().paulozx.AutoPredMode == 'PingBased' and 2 or 1, -- Default to PingBased
...
VisualsLeft:AddToggle('BoxESP', {
    ...
    Default = false,
    Callback = function(Value)
        getgenv().paulozx.ESP.BoxESP = Value
    end
})
...
VisualsLeft:AddToggle('SkeletonESP', {
    ...
    Default = false,
    Callback = function(Value)
        getgenv().paulozx.ESP.SkeletonESP = Value
    end
})

VisualsLeft:AddToggle('ChamsESP', {
    Text = 'Chams ESP',
    Default = false,
    Callback = function(Value)
        getgenv().paulozx.ESP.ChamsESP = Value
    end
})

VisualsLeft:AddToggle('TextESP', {
    Text = 'Text ESP (Name, Health, Tool, Distance)',
    Default = false,
    Callback = function(Value)
        getgenv().paulozx.ESP.TextESP = Value
    end
})

VisualsLeft:AddToggle('HealthBar', {
    Text = 'Health Bar',
    Default = false,
    Callback = function(Value)
        getgenv().paulozx.ESP.HealthBar = Value
    end
})

local VisualsRight = Tabs.Visuals:AddRightGroupbox('Target Visuals')

getgenv().paulozx.TargetVisuals = {
...
VisualsRight:AddToggle('TargetHighlight', {
    Text = 'Target Highlight',
    Default = false,
    Callback = function(Value)
        getgenv().paulozx.TargetVisuals.TargetHighlight = Value
    end
})

VisualsRight:AddToggle('HitChams', {
    Text = 'Hit Chams',
    Default = false,
    Callback = function(Value)
        getgenv().paulozx.TargetVisuals.HitChams = Value
    end
})

VisualsRight:AddToggle('HitSkeleton', {
    Text = 'Hit Skeleton',
    Default = false,
    Callback = function(Value)
        getgenv().paulozx.TargetVisuals.HitSkeleton = Value
    end
})
...
local sounds = {
    ...
    Bruh = "https://github.com/CongoOhioDog/SoundS/blob/main/bruh%20sample.mp3?raw=true",
    BoneBreakage = "https://github.com/CongoOhioDog/SoundS/blob/main/bone%20breakage.mp3?raw=true",
    Fein = "https://github.com/CongoOhioDog/SoundS/blob/main/highly%20defined%20fein.mp3?raw=true",
    Unicorn = "https://github.com/CongoOhioDog/SoundS/blob/main/shiny%20unicorn%20for%20dh.mp3?raw=true",
    Kitty = "https://github.com/CongoOhioDog/SoundS/blob/main/Kitty.mp3?raw=true",
    Bird = "https://github.com/CongoOhioDog/SoundS/blob/main/bird%20chirping%20for%20DH.mp3?raw=true",
    BirthdayCake = "https://github.com/CongoOhioDog/SoundS/blob/main/Birthday%20cake%20for%20dh.mp3?raw=true",
...
VisualsRight:AddDropdown('HitSound', {
    Values = hitsoundNames,
    Default = 1,
    Text = 'Hit Sound',
    Callback = function(Value)
        getgenv().paulozx.TargetVisuals.HitSound = Value
    end
})
