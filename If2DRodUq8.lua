--===================================================================================--
-- KHIZAR PREMIUM HUB v5.1 - MAXIMUM PROTECTION ENGINE                               --
-- Optimized for Delta Executor | Hide and Seek Extreme                              --
-- Size: ~16.8 KB | 10-Layer Bypass + Auto-Scrolling Player Matrix + Custom Inputs    --
--===================================================================================--
...
-- Premium Structural Configuration State (With Dynamic Custom Inputs)
local TargetPlayer = nil
local Chasing = false
local ESPEnabled = false
local DefaultSpeed = 16
local TweenSpeedFactor = 40 
local ESPMaxDistance = 2000 

-- Hidden Security Data Storage & Garbage Collection Management Table
local HiddenState = setmetatable({}, {__mode = "k"})
HiddenState.RealSpeed = DefaultSpeed
HiddenState.AntiKickActive = true
HiddenState.NetworkLatencyBypass = true
HiddenState.MetatableValidation = true
...
-- LAYER 1 & 2: Environment Simulation & Internal Memory Structure Protection
local SecurityLayerEnvironment = {
    MemoryAllocationTracking = false,
    CclosureDetourBypass = true,
    AntiMetatableScan = true
}
...
RawMeta.__namecall = newcclosure(function(Self, ...)
    ...
    if not checkcaller() and (Method == "FireServer" or Method == "InvokeServer") then
        ...
        if string.find(EngineName, "cheat") or string.find(EngineName, "kick") or string.find(EngineName, "ban") or string.find(EngineName, "detection") or string.find(EngineName, "teleport") then
            return nil 
        end
    end
...
-- LAYER 8: Raycast Matrix Virtual Spoofing System
if hookfunction then
    ...
    OldRaycast = hookfunction(Workspace.Raycast, newcclosure(function(Self, Origin, Direction, Params)
        if not checkcaller() and TargetPlayer and Chasing then
            -- Layer 8 Virtual Normal Vector Override Injection
...
local function CreateHighlightESP(Player)
    ...
    local function ApplyESP(Character)
        ...
        -- Premium Aesthetic Highlight Box Framework for Absolute Visibility
...
-- Dynamic Loop for Live Distance Checking on ESP Channels
...
--===================================================================================--
-- INTERFACE CORE GENERATOR (Premium Layout + Auto Scroll Fix + Inputs)               --
--===================================================================================--
...
-- Main Functional Hub Container Frame
...
Title.Text = "KHIZAR SCROLL AUTO v5.1"
...
-- Scrolling Matrix List System (With Full Canvas Real-Time Adaptation)
local ScrollFrame = Instance.new("ScrollingFrame")
ScrollFrame.Size = UDim2.new(0, 300, 0, 180) 
...
-- DYNAMIC SCROLL CALCULATION FIX NODE
ListLayout:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(function()
    ScrollFrame.CanvasSize = UDim2.new(0, 0, 0, ListLayout.AbsoluteContentSize.Y + 10)
end)

-- ================= CUSTOM INPUT FIELDS REGISTRATION SYSTEMS ================= --
...
--===================================================================================--
-- RUNTIME DATA STREAMING & PIPELINES MATRIX                                         --
--===================================================================================--
...
-- Initialize Micro Event Listeners for Character Verification
...
-- LAYER 3 & 5: Physics Overwrite & Visual Velocity Vector Anchor Loop
    ...
    pcall(function()
        ...
        if Chasing and TargetPlayer and TargetPlayer.Character and TargetPlayer.Character:FindFirstChild("HumanoidRootPart") then
            ...
            if HRP and Hum and Hum.Health > 0 then
                -- State Lockdown for Teleportation Checks Mitigation
                Hum:ChangeState(Enum.HumanoidStateType.Running)
                HRP.AssemblyLinearVelocity = Vector3.new(0, 0, 0)
                
                -- Dynamic Collision Removal Loop (Deewaron Ke Aar-Paar Flight Engine)
                ...
                -- Precise Real-Time Vector Calculation Nodes
                local Distance = (TargetHRP.Position - HRP.Position).Magnitude
                local Duration = Distance / TweenSpeedFactor
                
                -- LAYER 9: Heartbeat Throttling Matrix Reset
