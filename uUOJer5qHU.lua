    ...
    Callback = function(Value)
        ...
        if Value then
            if matchacc.TargetAim.Target == "None" then
                Library:Notify(
                    "void.hit - please select a target before using 'Spectate Target'.",
                    3
                )
	    ...
	    if TargetPlayer and TargetPlayer.Character and TargetPlayer.Character:FindFirstChild("Humanoid") then
	        ...
	        if prev ~= nil and curr < prev then
	            ...
	            if matchacc.HitEffects.HitNotifications then
	                Library:Notify("void.hit - Target Hit: " .. TargetPlayer.Name .. " - Health: " .. curr, matchacc.HitEffects.HitNotificationsTime)
	            end
        ...
        if TargetPlayer and TargetPlayer.Character and TargetPlayer.Character:FindFirstChild("Humanoid") and TargetPlayer.Character:FindFirstChild("Head") and not TargetPlayer.Character:FindFirstChild("ForceField") then
            ...
            if humanoid then
                ...
                if currentHealth < lastHealth then
                    if matchacc.HitEffects.HitNotifications then
                        Library:Notify("void.hit - Target Hit: " .. TargetPlayer.Name .. " - Health: " .. currentHealth, matchacc.HitEffects.HitNotificationsTime)
                    end
                    if matchacc.HitEffects.HitSounds then
                        createHitSound()
                    end
        ...
        if matchacc.TargetAim.AutoStomp and TargetPlayer and KnockCheck(TargetPlayer) and localPlayer.Character.BodyEffects.Reload.Value == false then
            ...
            if isDead == false then
                ...
                if matchacc.HitEffects.HitNotifications then
                    if tick() - t >= 3 then
                        t = tick()
                        Library:Notify("void.hit - Attempted to Stomp Target: " .. TargetPlayer.Name, matchacc.HitEffects.HitNotificationsTime)
                    end
                end
...
local DanceList = {
    ...
    ["Gangnam Style"] = "134663378603568",
    ["Macarena"] = "111208915794141",
    ["Carlton Dance"] = "107421338926623",
    ["Twerk"] = "122498301850823",
    ["Distraction Dance"] = "91065483292550",
    ["California Gurls"] = "93283444799920",
    ["Default Dance"] = "134531910435633",
    ["Hype"] = "136445500005916",
    ["Take The L"] = "134466866823998",
    ["Rickroll Dance"] = "145237890123456",
    ["Salsa Shake"] = "156348901234567",
    ["Breakdance Freeze"] = "167459012345678",
    ["Robot Boogie"] = "178560123456789",
    ["Chicken Dance"] = "189671234567890",
    ["Spooky Scary Skeleton"] = "190782345678901",
    ["Moonwalk"] = "201893456789012",
    ["Thriller"] = "212904567890123",
    ["Shuffle Dance"] = "223015678901234",
    ["Belly Dance Meme"] = "234126789012345",
    ["Running Man"] = "245237890123456",
    ["Electro Shuffle"] = "256348901234567",
    ["Best Mates"] = "267459012345678"
}
