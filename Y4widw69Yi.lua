...
local TeamCheckEnabled = false  -- Fixed Global Variable
...
--// Team Check Button Hooked Perfectly
...
--// ============================================================================
--// 4. ADVANCED TARGET FINDER (Perfect Ground, Height & Team Filters)
--// ============================================================================
