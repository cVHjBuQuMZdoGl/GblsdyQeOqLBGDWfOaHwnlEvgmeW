...
local HitpartContainer = UIBuilder:Create("Frame", { Name = "HitpartContainer", Size = UDim2.new(0, 171, 0, 22), BackgroundTransparency = 1, ClipsDescendants = true, LayoutOrder = 5, Parent = PredictionPanel })
...
local PriorityContainer = UIBuilder:Create("Frame", { Name = "PriorityContainer", Size = UDim2.new(0, 171, 0, 22), BackgroundTransparency = 1, ClipsDescendants = true, LayoutOrder = 6, Parent = PredictionPanel })
...
local resolverModesList = {"Delta-Time Fallback", "LookVector Clamp", "No Vertical", "Static Zero", "Predictive Average", "LookVector", "recalculate", "MoveDirection"}
local ResolverContainer = UIBuilder:Create("Frame", { Name = "ResolverContainer", Size = UDim2.new(0, 171, 0, 22), BackgroundTransparency = 1, ClipsDescendants = true, LayoutOrder = 7, Parent = PredictionPanel })
