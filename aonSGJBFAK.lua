...
--// ============================================================================
--// 4. ADVANCED SMART TARGET FINDER
--// ============================================================================
local function getAbsoluteClosestPlayer()
    ...
    for _, player in pairs(Players:GetPlayers()) do
        if player ~= LocalPlayer and player.Character and player.Character:FindFirstChild("HumanoidRootPart") and player.Character:FindFirstChild("Humanoid") and player.Character.Humanoid.Health > 0 then
            ...
            -- 2. SMART AIR-DROP BYPASS (Aeroplane/Sky Spawn Check)
            -- Agar banda aasmaan se gir raha hai ya uski sky velocity zyada hai toh check skip karega
            if targetPos.Y > (myPos.Y + 120) or targetHRP.Velocity.Y < -50 then 
                continue 
            end
            
            -- 3. PERFECTED GROUND/UNDERGROUND CHECK
            -- Agar dushman map depth limit se neeche glitch hua hai
            ...
            -- Agar direct visual line block hai zameen ki wajah se toh skip
...
--// ============================================================================
--// 5. ENGINE LOOPS (Camera Tracking Only)
--// ============================================================================
