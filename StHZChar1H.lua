...
do
    ...
    -- GetCorners = GetVertices (thanks Nahida)
...
local InfRangeGroup = RageTab:AddRightGroupbox('Infinite Range')
...
local AntiVoidGroup = RageTab:AddLeftGroupbox('Anti-Void')
...
--// =========================
--// RAGEBOT -> NO FALLEN PARTS DESTROY (workspace.FallenPartsDestroyHeight)
--// =========================
...
local StompGroup = RageTab:AddRightGroupbox('Stomp')
...
do
    ...
    -- Stomp Target loop:
    -- quando o alvo travado (Target) e derrubado, TP ate ele, stompa e volta pra posicao original
        ...
        while true do
            ...
            if StompConfig.StompTarget and Target and Target.Character then
                ...
                elseif not knocked then
                    -- alvo levantou / trocou: libera pra stompar de novo no proximo knock
