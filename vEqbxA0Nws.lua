...
-- Xóa UI cũ nếu đã chạy script trước đó
...
-- 2. Khung chính duy nhất ở góc (Gộp 2 cái thành 1)
L_1_.MainFrame = Instance.new("Frame")
L_1_.MainFrame.Name = "MainFrame"
L_1_.MainFrame.Size = UDim2.new(0, 180, 0, 70) -- Tăng chiều cao để chứa cả 2 dòng
L_1_.MainFrame.Position = UDim2.new(1, -10, .5, 0)
L_1_.MainFrame.AnchorPoint = Vector2.new(1, .5)
...
-- Bo góc và Viền Đen
Instance.new("UICorner", L_1_.MainFrame).CornerRadius = UDim.new(0, 8)
L_1_.Stroke = Instance.new("UIStroke", L_1_.MainFrame)
L_1_.Stroke.Thickness = 2
L_1_.Stroke.Color = Color3.fromRGB(0, 0, 0)

-- 3. Tiêu đề Hub (Dòng trên)
L_1_.Title = Instance.new("TextLabel", L_1_.MainFrame)
L_1_.Title.Size = UDim2.new(1, 0, 0, 35)
L_1_.Title.Position = UDim2.new(0, 0, 0, 5)
L_1_.Title.BackgroundTransparency = 1
L_1_.Title.Text = "chuoiray Hub"
L_1_.Title.TextColor3 = Color3.fromRGB(0, 0, 0) -- Màu đen
L_1_.Title.TextSize = 16
L_1_.Title.Font = Enum.Font.GothamBold
L_1_.Title.Parent = L_1_.MainFrame

-- 4. Trạng thái Status (Dòng dưới)
L_1_.Status = Instance.new("TextLabel", L_1_.MainFrame)
L_1_.Status.Size = UDim2.new(1, 0, 0, 25)
L_1_.Status.Position = UDim2.new(0, 0, 0, 35)
L_1_.Status.BackgroundTransparency = 1
L_1_.Status.Text = "Status : N/A"
L_1_.Status.TextColor3 = Color3.fromRGB(0, 0, 0) -- Màu đen
L_1_.Status.TextSize = 13
L_1_.Status.Font = Enum.Font.Gotham
L_1_.Status.Parent = L_1_.MainFrame
