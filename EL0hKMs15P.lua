...
local ESPHolderGui = Instance.new("ScreenGui", { Parent = UIParent, Name = "UniversalTargetESPHolder" })
...
local function buildTargetESP(char)
    clearTargetESP()
    local Container = Instance.new("Folder", {Name = "ActiveTargetStructure", Parent = ESPHolderGui})
    ...
    elements.Gradient1 = Instance.new("UIGradient", {Parent = elements.Box, Enabled = getgenv().ESP.Drawing.Boxes.GradientFill, Color = ColorSequence.new{ColorSequenceKeypoint.new(0, getgenv().ESP.Drawing.Boxes.GradientFillRGB1 or getgenv().Colors.Accent), ColorSequenceKeypoint.new(1, getgenv().ESP.Drawing.Boxes.GradientFillRGB2 or getgenv().Colors.Background)}})
    elements.Outline = Instance.new("UIStroke", {Parent = elements.Box, Enabled = getgenv().ESP.Drawing.Boxes.Gradient, Transparency = 0, Color = getgenv().Colors.TextPrimary, LineJoinMode = Enum.LineJoinMode.Miter})
    elements.Gradient2 = Instance.new("UIGradient", {Parent = elements.Outline, Enabled = getgenv().ESP.Drawing.Boxes.Gradient, Color = ColorSequence.new{ColorSequenceKeypoint.new(0, getgenv().Colors.Accent), ColorSequenceKeypoint.new(1, getgenv().Colors.Background)}})
    elements.HealthbarGradient = Instance.new("UIGradient", {Parent = elements.Healthbar, Enabled = getgenv().ESP.Drawing.Healthbar.Gradient, Rotation = -90, Color = ColorSequence.new{ColorSequenceKeypoint.new(0, getgenv().ESP.Drawing.Healthbar.GradientRGB1), ColorSequenceKeypoint.new(0.5, getgenv().ESP.Drawing.Healthbar.GradientRGB2), ColorSequenceKeypoint.new(1, getgenv().ESP.Drawing.Healthbar.GradientRGB3)}})
