...
local DesyncEnabled = false -- New Feature State
...
--// ============================================================================
--// 2. GUI OVERHAUL (With Desync Button)
--// ============================================================================
...
MainFrame.Size = UDim2.new(0, 250, 0, 315) -- Size thoda bada kiya naye button ke liye
...
-- EXPERIMENTAL DESYNC BUTTON (Sirf Alt Account ke liye)
local DesyncBtn = createButton("FAKE POSITION: OFF", UDim2.new(0, 20, 0, 200), function(btn)
    ...
    btn.BackgroundColor3 = DesyncEnabled and Color3.fromRGB(138, 43, 226) or Color3.fromRGB(180, 40, 40) -- Purple color for heavy exploit
end)
...
--// ============================================================================
--// 5. CORE ENGINES: DESYNC & CAMERA CONTROLLER
--// ============================================================================
local randomGenerator = Random.new()

-- Desync Logic (Fake Position Simulator)
RunService.Heartbeat:Connect(function()
    ...
    if myCharacter and myCharacter:FindFirstChild("HumanoidRootPart") then
        ...
        if DesyncEnabled then
            -- Server ki physics updates break karne ke liye velocity aur position calculations distort karte hain
            -- Isse log purani position par hit karenge lekin client-side tum aage hoge
            hrp.Velocity = Vector3.new(9e9, 0, 9e9) -- Vector breaking math
            task.wait()
